...
$to = "info@partyshakersla.com";
$subject = "New booking from partyshakers.com";
$errorMessages = array();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (!empty($errorMessages)) {
    $success = "Message Sending Failed, try again";
      ...
      redirect("../contact.php?responseMessage=Your message was not sent. Please email us at info@partyshakersla.com.#form");
  }
  else {
